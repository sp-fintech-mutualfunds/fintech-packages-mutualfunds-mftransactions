...
namespace Apps\Fintech\Packages\Mf\Transactions\Install;

use Apps\Fintech\Packages\Mf\Transactions\Install\Schema\MfTransactions;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_fintech_mf_transactions'  => [
                    'schema'        => new MfTransactions,
                    'model'         => new AppsFintechMfTransactions
                ]
            ];
